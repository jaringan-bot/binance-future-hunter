...
const CATALOG_METADATA: Record<string, CatalogMetadata> = {
  ...
  binance_get_liquidation_history: { category: "liquidation", tokenCost: "medium", useCase: "Total long/short liquidated per window waktu (via Coinalyze, TANPA harga)", dependencies: [] },
