...
const CATALOG_METADATA: Record<string, CatalogMetadata> = {
  ...
  binance_watch_orderbook_realtime: { category: "realtime", tokenCost: "medium", useCase: "Arm watch sub-detik order book satu pair (@depth@100ms), balik event lifecycle wall (APPEARED/GREW/SHRANK/VANISHED). Ambang wall di-skala volume 24h. TTL-bounded, on-demand", dependencies: [] },
