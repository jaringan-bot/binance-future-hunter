...
di bawah. `PROXY_URL`/`PROXY_SECRET` WAJIB (semua 79 tool butuh).
...
- 79 tools mencakup lima sudut analisis: bias arah pasar, area harga kunci
...
wajib buat semua 79 tool) — lihat bagian Setup di bawah.
